...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "prototypeApp@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "prototypeApp API";

        private String description = "prototypeApp API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "prototypeApp";
