...
public class MenuCategoryResourceIntTest {
    ...
    public void setup() {
        ...
        MenuCategoryResource menuCategoryResource = new MenuCategoryResource();
        ReflectionTestUtils.setField(menuCategoryResource, "menuCategoryService", menuCategoryService);
