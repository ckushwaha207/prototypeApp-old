...
class ProductGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Product entity")
        ...
        .repeat(2) {
            ...
            .post("/api/products")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "productId":"SAMPLE_TEXT", "barcodeId":"SAMPLE_TEXT", "name":"SAMPLE_TEXT", "skuCode":"SAMPLE_TEXT", "imageUrl":"SAMPLE_TEXT", "description":"SAMPLE_TEXT"}""")).asJSON
            .check(status.is(201))
